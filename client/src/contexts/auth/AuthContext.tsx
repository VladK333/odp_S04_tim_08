...
import { PročitajVrednostPoKljuču, ObrišiVrednostPoKljuču, SačuvajVrednostPoKljuču } from '../../helpers/local_storage';
...
const decodeJWT = (token: string): JwtTokenClaims | null => {
    try {
        ...
        if (decoded.id && decoded.email && decoded.isPremium) {
            return {
                id: decoded.id,
                email: decoded.email,
